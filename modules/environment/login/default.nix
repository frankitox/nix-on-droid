  ...
  config = {
    ...
    environment.files = {
      ...
      prootStatic =
        let
          crossCompiledPaths = {
            aarch64-linux = "/nix/store/87i0dxrws35rh03f1gzx1p7p2j6warfw-proot-termux-static-aarch64-unknown-linux-android-unstable-2026-06-04";
            x86_64-linux = "/nix/store/39v3kbfi545ksgihw3178mzs5nslgm13-proot-termux-static-x86_64-unknown-linux-android-unstable-2026-06-04";
          };
        in
